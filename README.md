...
CB-OHD is a mix of CollectionBuilder-CSV and Oral History as Data (OHD). It's meant to serve as a starter repository for those wanting to build oral history collections with CollectionBuilder. 
...
We hope to incorporate and document these features more fully in CollectionBuilder proper the next year, but for now this is a good start. 

The [CollectionBuilder-CSV template](https://github.com/CollectionBuilder/collectionbuilder-csv) used is from February 6, 2024 -- so any new updates after that date will not be included here. 
